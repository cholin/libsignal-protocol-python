# taken from signal_protocol_types.h (converted defines to enums)
def register_base_types(ffibuilder):
    ffibuilder.cdef("""
/*
* Base library types
*/
 ...
 * Ratchet types
 */
enum { RATCHET_CIPHER_KEY_LENGTH = 32 };
enum { RATCHET_MAC_KEY_LENGTH = 32 };
enum { RATCHET_IV_LENGTH = 16 };
